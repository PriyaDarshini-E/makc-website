        ...
        <div className="max-w-3xl space-y-3">
          ...
          <div className="hero-subtitle max-w-2xl">
            <p className="text-base sm:text-lg text-text-muted leading-relaxed">
              Smart audio is not just about playing music — it is about creating
              the perfect acoustic ambiance, distributing high-fidelity sound
              throughout your home, and making controls effortless. With
              professionally designed smart audio solutions in Bangalore, MAKc
              Automation helps you control every sound zone with ease.
              <img
