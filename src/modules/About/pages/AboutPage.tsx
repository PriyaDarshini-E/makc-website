...
export default function AboutPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Translates your lifestyle goals into a system that fits — patiently, technically and without the hard sell.",
    },
  ];
    ...
    <div className="text-text-main bg-bg-main overflow-hidden min-h-screen transition-colors duration-300">
      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center px-4 pt-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-text-muted max-w-2xl mx-auto leading-relaxed font-medium drop-shadow">
            MAKc Automation is locally owned and operated, being the best
            automation, security system, networking and lighting provider in
            the region.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-24 pb-16">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div
            className="lg:col-span-7 space-y-6 reveal-on-scroll reveal-left"
          ...
          >
            ...
            <p className="text-text-muted text-base leading-relaxed font-medium">
              Our service philosophy is simple: we anticipate needs. With
              state-of-the-art network monitoring and management, we manage
              your network 24/7 to identify issues and address them before
              they become problems, rather than putting out fires.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-border-main/50">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="font-bold font-serif text-text-main text-base mb-1">
                    Home Control
                  </h4>
                  <p className="text-xs text-text-muted leading-relaxed">
                    Control your Lights, Fan & Other Appliances with absolute
                    ease and scheduling.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted leading-relaxed">
                    We provide smart automation solutions that integrate
                    seamlessly into modern interiors.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            className="lg:col-span-5 reveal-on-scroll reveal-right"
            data-reveal-duration="0.8s"
          >
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {stats.map((stat, idx) => {
            ...
            return (
              <div
                key={stat.label}
                className="bg-bg-surface border border-border-main rounded-2xl p-5 sm:p-6 text-center shadow-sm transition-all hover:border-accent-blue/30 hover:-translate-y-1 hover:shadow-lg reveal-on-scroll reveal-up"
                data-reveal-delay={`${idx * 80}ms`}
                data-reveal-duration="0.6s"
              >
                <div className="w-10 h-10 mx-auto rounded-full bg-accent-blue/10 text-accent-blue flex items-center justify-center mb-3">
                  <Icon className="w-5 h-5" />
                </div>
                <div className="text-3xl sm:text-4xl font-bold text-accent-blue font-serif tracking-tight">
                  {stat.value}
                </div>
                <div className="text-[11px] sm:text-xs text-text-muted font-semibold uppercase tracking-widest mt-1.5">
                  {stat.label}
                </div>
              </div>
            );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-sm text-text-muted leading-relaxed max-w-xl">
                We design, build, and deploy smart solutions that combine
                various technologies. Our advanced and customized solutions
                for buildings and homes allow people to control their
                environment with the perfect touch.
              </p>
            ...
            {/* Stat items (kept as quick-glance card) */}
            <div className="lg:col-span-5 space-y-4">
              {[
                {
                  value: "24/7",
                  label: "Network Monitoring & Support",
                },
                { value: "48hr", label: "Average On-Site Response" },
                ...
                >
                  ...
                  <span className="text-3xl font-bold text-accent-blue font-serif">
                    {stat.value}
                  </span>
                </div>
              ))}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {/* Vision Panel */}
          <div
            className="bg-bg-surface border border-border-main p-8 sm:p-10 rounded-3xl flex flex-col justify-between transition-all hover:border-accent-blue/15 shadow-md reveal-on-scroll reveal-left"
            data-reveal-duration="0.8s"
          >
            <div>
              ...
              <p className="text-sm text-text-muted leading-relaxed">
                To be recognized as the leading smart home automation and
                security systems integrator in the region, delivering safety,
                comfort, and energy efficiency through out-of-the-box system
                configurations.
              </p>
            </div>
          ...
          {/* Mission Panel */}
          <div
            className="bg-bg-surface border border-border-main p-8 sm:p-10 rounded-3xl flex flex-col justify-between transition-all hover:border-accent-blue/15 shadow-md reveal-on-scroll reveal-right"
            data-reveal-duration="0.8s"
          >
            <div>
              <div className="w-12 h-12 rounded-full border border-border-main bg-bg-main flex items-center justify-center text-accent-blue mb-6 apple-border-shine">
              ...
              <p className="text-sm text-text-muted leading-relaxed">
                To design and implement top-quality smart home solutions
                through cutting-edge technology, exceptional customer support,
                and custom integrations to satisfy our clients' structural
                needs.
              </p>
            </div>
            <div className="mt-8 pt-4 border-t border-border-main/50 flex items-center gap-2 text-xs font-bold text-accent-blue tracking-wider uppercase">
        ...
        <section
          className="border-t border-border-main/50 pt-20 reveal-on-scroll reveal-up"
          data-reveal-duration="0.8s"
        >
        ...
        <section className="border-t border-border-main/50 pt-20">
          <div
            className="text-center max-w-2xl mx-auto mb-16 reveal-on-scroll reveal-up"
            data-reveal-duration="0.8s"
          >
            <span className="text-accent-blue text-xs font-bold uppercase tracking-widest block mb-3">
              Design Specialists
            </span>
            <h2 className="text-4xl font-serif font-bold tracking-tight text-text-main mb-4">
              Meet Our Team!
            </h2>
            <p className="text-text-muted text-sm leading-relaxed font-medium">
              We work with top compatibility to deliver maximum value, keeping
              our clients' homes happy and safe.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {teamMembers.map((member, idx) => (
              ...
              >
                ...
                <div className="p-5">
                  <h4 className="text-lg font-serif font-bold text-text-main text-center">
                    {member.name}
                  </h4>
                  <p className="text-[10px] text-text-muted uppercase font-bold tracking-widest mt-1.5 text-center">
                    {member.role}
                  </p>
                  <p className="text-xs text-text-muted leading-relaxed mt-4 text-center">
                    {member.bio}
                  </p>
                </div>
              </div>
        ...
        {/* CONNECT BANNER CTA */}
        <ConnectBanner
          title="Let's Build Your Smart Home"
          description="Our design specialists are ready to consult on your home automation needs. Visit our Brookefield Experience Center or reach us by phone or email for a tailored estimate."
        />
      </div>
    </div>
  );
